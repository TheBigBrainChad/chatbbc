...
import type { SkillSummary, SkillLibrary, SkillsDraftScope, SkillState } from '../shared/skills.js';
...
const api = {
  ...
  // is no separate channel for the two switches, and no channel that removes a skill.
