...
implementation. A plan step, a single-function utility, a config
...
the normal development workflow; no plan document. Spike: the terminal
...
- Write the spec plainly and concisely; no extra style skill is shipped with this pack
