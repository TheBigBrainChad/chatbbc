...
**Complete worked example:** Upstream shipped a full test campaign under `examples/`; that directory is not part of this pack. The RED/GREEN/REFACTOR walkthrough below is the worked example — follow it directly.
