...
Use this template when spawning a code reviewer worker.
    ...
    - label: "Review code changes"
      task: |
        ...
        **Head:** [HEAD_SHA]
        ...
        for a way to delegate part of it. This process already provides every
        review seat the work gets; a second opinion you arrange for yourself
